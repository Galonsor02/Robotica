...
class SpecificWorker : public GenericWorker
{
    ...
    private:
        ...
        std::vector<QLineF> detect_wall_lines(const auto &helios, QGraphicsScene *scene);
        std::vector<Eigen::Vector2f> remove_wall_points(const auto &lines, const auto &bpearl);
